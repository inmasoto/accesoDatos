...
public class BdEje9Derby {

	public static void main(String[] args) {
		try {
			Class.forName("org.apache.derby.jdbc.EmbeddedDriver"); // cargar el
																	// driver
			...
			while (resul.next()) {
				String catalogo = resul.getString(1); // columna 1 que devuelve
														// ResulSet
